  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-sm bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <h2 className="text-xl font-semibold text-slate-800 mb-1">Espace élève</h2>
        <p className="text-sm text-slate-500 mb-6">
          {mode === "login" ? "Connectez-vous à votre compte." : "Créez votre compte élève."}
        </p>
        ...
        <form onSubmit={mode === "login" ? handleLogin : handleRegister} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition disabled:opacity-60"
          >
            {loading
              ? "Veuillez patienter..."
              : mode === "login"
